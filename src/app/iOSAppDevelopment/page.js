          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-24 flex flex-col lg:flex-row justify-between items-center relative z-10">
            ...
            >
              ...
              <p className="text-indigo-200 mb-6 text-sm md:text-base">
                At <strong>Macco Tech</strong>, we create high-performance iOS apps that align with your business objectives and exceed user expectations. From sleek UI to powerful backend integration, we deliver tailored solutions that empower your brand on the App Store.
              </p>
