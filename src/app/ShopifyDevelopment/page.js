        ...
        <div className="container mx-auto px-4 md:px-8 lg:flex items-center justify-between">
          ...
          >
            ...
            <p className="text-gray-600 mb-6 text-base">
              At Macco Tech, we specialize in crafting tailored Shopify solutions that help businesses thrive online. From startups to established brands, we create seamless and engaging eCommerce stores that leave a lasting impact. Our Shopify development services are designed to provide cost-effective and transparent solutions, ensuring that your online store stands out with functionality, speed, and a user-friendly experience.
            </p>
