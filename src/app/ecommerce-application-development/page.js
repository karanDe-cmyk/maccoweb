...
>
    ...
    <motion.div
        ...
        className="relative z-10 text-left text-white px-4 md:px-8 py-12 md:py-24 w-full max-w-xl"
    >
      ...
      {/* Promotion Section */}
      <section className="relative py-24 bg-gradient-to-br from-blue-50 via-pink-50 to-yellow-50 overflow-hidden">
  {/* Animated Circles */}
