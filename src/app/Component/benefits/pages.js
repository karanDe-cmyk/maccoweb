...
// //   EyeIcon,
// // } from '@heroicons/react/24/outline'; // Heroicons से आइकॉन्स का उपयोग

// // const benefits = [
// //   {
// //     icon: <ShieldCheckIcon className="h-10 w-10 text-indigo-500 mb-4" />,
// //     title: 'Peace of mind',
// //     description: 'Experience a work environment where your growth and well-being are prioritized. Focus and succeed with a team that values you.',
// //   },
// //   {
// //     icon: <HeartIcon className="h-10 w-10 text-red-500 mb-4" />,
// //     title: 'Private healthcare',
// //     description: 'Your health is our priority. Enjoy comprehensive healthcare benefits designed to keep you and your loved ones at ease.',
// //   },
// //   {
// //     icon: <LightBulbIcon className="h-10 w-10 text-yellow-500 mb-4" />,
// //     title: 'Internal workshops',
// //     description: 'Learn, grow, and excel with exclusive workshops that help you master new skills and elevate your career to the next level.',
// //   },
// //   {
// //     icon: <EyeIcon className="h-10 w-10 text-blue-500 mb-4" />,
// //     title: 'Additional accessories',
// //     description: 'Get the tools and perks you need to work smarter, better, and with style. Your success deserves every advantage.',
// //   },
// //   {
// //     icon: <BookOpenIcon className="h-10 w-10 text-green-500 mb-4" />,
// //     title: 'Books & paid content',
// //     description: 'Access exclusive, high-quality premium resources, eBooks, and learning material to enhance your skills, broaden your knowledge, and stay ahead in your field.',
// //   },
// //   {
// //     icon: <GlobeAltIcon className="h-10 w-10 text-teal-500 mb-4" />,
// //     title: 'World class infrastructure',
// //     description: 'Work in a state-of-the-art environment designed to boost creativity and productivity for every individual.',
// //   },
// //   {
// //     icon: <UserGroupIcon className="h-10 w-10 text-purple-500 mb-4" />,
// //     title: 'Community Meetups',
// //     description: 'Engage with like-minded professionals, share innovative ideas, and grow together through regular meetups and insightful discussions.',
// //   },
// //   {
// //     icon: <PresentationChartLineIcon className="h-10 w-10 text-orange-500 mb-4" />,
// //     title: 'Training and Mentorship',
// //     description: 'Gain valuable insights and guidance from industry experts to accelerate your professional development.',
// //   },
// // ];
...
// //           Join a team where your talent meets endless opportunities. At{' '}
// //           <span className="font-semibold text-indigo-600">Macco Tech</span>, we
// //           recognize your potential and help shape a future driven by your unique
// //           skills.
// //         </p>
// //       </div>
...
// // ./src/app/Component/benefits/pages.js
