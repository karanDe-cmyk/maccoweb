...
//   <div key={challenge.id} className="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition-all">
...
//         <div className="mt-20">
//           <img
//             src="https://www.brightwork.com/wp-content/uploads/you-x-ventures-1439463-unsplash-min-2880x1800.jpg"
//             alt="Team Working on Project"
//             className="w-full max-w-5xl mx-auto rounded-xl shadow-lg object-cover max-h-[400px]"
//           />
//         </div>
//       </div>
//     </div>
