...
export default function Navbar() {
  ...
  return (
    <nav className="bg-transparent shadow-lg relative z-50">
      <div className="max-w-7xl mx-auto px-6 relative">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <div className="flex-shrink-0">
          ...
          <div className="hidden md:flex space-x-6 items-center relative">
            <Link href="/home">
              <button className="text-gray-700 hover:text-purple-700 transition-all cursor-pointer">Home</button>
            </Link>
...
>
  <Link href='/service'>
  <button className="text-gray-700 hover:text-purple-700 transition-all cursor-pointer">Services</button>
  </Link>
  {isServicesMenuOpen && (
    <div className="absolute top-full left-4 -translate-x-1/2 bg-white shadow-lg z-50 py-6 w-[100%] px-10 w-[1200px] rounded-md">
      <div className="grid grid-cols-3 gap-10">
        {/* Column 1 */}
        <div>
          <h4 className="text-purple-700 font-bold mb-2">Mobile App Development</h4>
          <ul className="space-y-1 text-gray-700">
            <li><Link href="/AndroidAppDevelopment">Android App Development</Link></li>
            <li><Link href="/iOSAppDevelopment">iOS App Development</Link></li>
            <li><Link href="/ReactNativeAppDevelopment">React-Native App Development</Link></li>
            <li><Link href="/ecommerce-application-development">E-Commerce</Link></li>
          </ul>
        </div>

        {/* Column 2 */}
        <div>
          <h4 className="text-purple-700 font-bold mb-2">Ecommerce solution</h4>
          <ul className="space-y-1 text-gray-700">
            <li><Link href="ShopifyDevelopment">Shopify Development</Link></li>
        ...
        {/* Column 3 */}
        <div>
          <h4 className="text-purple-700 font-bold mb-2"> JS FRAMEWORKS</h4>
          <ul className="space-y-1 text-gray-700">
            <li><Link href="ReactJsDevelopment">React Js Development</Link></li>
        ...
        {/* <div>
          ...
          <ul className="space-y-1 text-gray-700">
            ...
            {/* <Link href="/what-we-do"><button className="text-gray-700 hover:text-purple-700">What We Do</button></Link> */}
            <Link href="/about-us"><button className="text-gray-700 hover:text-purple-700 cursor-pointer">About Us</button></Link>
            <Link href="/careers"><button className="text-gray-700 hover:text-purple-700 cursor-pointer">Careers</button></Link>
            <Link href="/portfolio"><button className="text-gray-700 hover:text-purple-700 cursor-pointer">Portfolio</button></Link>
            <Link href="/case-study"><button className="text-gray-700 hover:text-purple-700 cursor-pointer">Case Study</button></Link>
            <Link href="/pricing"><button className="text-gray-700 hover:text-purple-700 cursor-pointer">Pricing</button></Link>
            <Link href="/contact">
              <button className="bg-blue-600 text-white rounded-[30px] px-6 py-2 hover:bg-purple-600 transition-all cursor-pointer">Contact Us</button>
            </Link>
          </div>
        </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-md z-40">
            <div className="px-4 py-2 space-y-2">
              <Link href="/what-we-do"><button className="block w-full text-left py-2 hover:bg-gray-100">What We Do</button></Link>
