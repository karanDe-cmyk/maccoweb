...
//         <h2 className="text-3xl font-bold text-blue-600 text-center mb-12">Key Advantages of <span className="text-blue-400">React</span>JS</h2>
//         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 justify-center mt-8">
//           {advantages.map((advantage, index) => (
//             <div
//               key={index}
//               className="bg-white rounded-md shadow-sm p-6 flex flex-col items-center text-center"
//             >
//               <div className="w-12 h-12 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mb-3">
//                 <i className={`fa ${advantage.icon} fa-lg`}></i> {/* Placeholder for icon */}
//               </div>
