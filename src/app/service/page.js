  ...
  return (
    <>
      ...
      <div className="relative text-white py-14 sm:py-20 lg:py-28 px-6 sm:px-8 lg:px-12 xl:px-16 overflow-hidden" style={{top: '85px'}}>
        ...
        <Image
          src="/service.avif"
          // src="https://png.pngtree.com/background/20210711/original/pngtree-corporate-literary-minimalist-light-blue-training-background-poster-picture-image_1125432.jpg"
        ...
        <div className="absolute inset-0 bg-indigo-700 opacity-20 mix-blend-multiply z-0" />
