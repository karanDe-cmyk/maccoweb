...
//             <div className="w-12 h-12 bg-pink-100 rounded-md flex items-center justify-center mb-4"><img src="/img1.webp"/></div>
...
//           <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300 opacity-0 translate-y-6 fade-in-up">
//             <div className="w-12 h-12 bg-pink-100 rounded-md flex items-center justify-center mb-4"><img src="/image.png"/></div>
...
//           <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300 opacity-0 translate-y-6 fade-in-up">
//             <div className="w-12 h-12 bg-orange-100 rounded-md flex items-center justify-center mb-4"><img src="/image3.png"/></div>
...
//           <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300 opacity-0 translate-y-6 fade-in-up">
//             <div className="w-12 h-12 bg-teal-100 rounded-md flex items-center justify-center mb-4"><img src="/image.png"/></div>
...
//           <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300 opacity-0 translate-y-6 fade-in-up">
//             <div className="w-12 h-12 bg-indigo-100 rounded-md flex items-center justify-center mb-4"><img src="/image3.png"/></div>
...
//           <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300 opacity-0 translate-y-6 fade-in-up ">
//             <div className="w-12 h-12 bg-lime-100 rounded-md flex items-center justify-center mb-4"><img src="/img1.webp"/></div>
...
//             {/* Wearable Development Card */}
//             <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300 opacity-0 translate-y-6 fade-in-up">
//               <div className="w-12 h-12 bg-teal-100 rounded-md flex items-center justify-center mb-4">
//                 <img 
//                   src="/image.png" 
//                   alt="Wearable Development" 
//                   loading="lazy" 
//                   width="48" 
//                   height="48" 
//                 />
//               </div>
//               <h3 className="text-xl font-semibold text-gray-800 mb-2">Wearable App Development</h3>
//               <p className="text-gray-600 text-sm mb-4">We offer innovative wearable app development services, ensuring seamless integration of wearables with mobile devices for enhanced user experience.</p>
//               <a href="#" className="text-blue-500 hover:text-blue-700 font-semibold text-sm">Read More →</a>
//             </div>
//             <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300 opacity-0 translate-y-6 fade-in-up">
...
//     Our UI/UX design services focus on creating intuitive and visually compelling interfaces that enhance user satisfaction and product usability.
//   </p>
//   <a href="#" className="text-blue-500 hover:text-blue-700 font-semibold text-sm">Read More →</a>
// </div>
...
//   <h3 className="text-xl font-semibold text-gray-800 mb-2">Web App Development</h3>
//   <p className="text-gray-600 text-sm mb-4">
//     We build scalable and high-performance web applications tailored to your business goals, using modern frameworks and best practices.
//   </p>
//   <a href="#" className="text-blue-500 hover:text-blue-700 font-semibold text-sm">Read More →</a>
// </div>
