    ...
    <section>
      <div className="bg-gradient-to-br from-green-100 to-teal-100 py-16 md:py-24 lg:py-32 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-20">
          <svg className="absolute top-1/4 left-1/4 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 fill-current text-green-500 animate-ping" viewBox="0 0 20 20">
            <circle cx="10" cy="10" r="8" />
          </svg>
          <svg className="absolute bottom-1/4 right-1/4 transform translate-x-1/2 translate-y-1/2 w-48 h-48 md:w-64 md:h-64 lg:w-72 lg:h-72 fill-current text-teal-500 animate-spin-slow" viewBox="0 0 20 20">
        ...
        <div className="md:grid md:grid-cols-2 md:gap-8 items-center">
          ...
          <div className="mt-8 md:mt-0">
            ...
            <img
              ...
              src="/hr-girl2.jpg"  //  Replace this URL!
...
<div className="bg-white py-16 md:py-24">
    ...
    {/* <section className="bg-gradient-to-r from-slate-100 to-indigo-100 py-16"> */}
...
<div className="bg-white py-16 lg:py-24">
      <div className="container mx-auto px-4  sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 sm:gap-6">
            <a
              ...
              className="bg-orange-600 hover:bg-orange-700 text-white font-semibold py-3 px-6 rounded-md shadow-md transition duration-300 ease-in-out flex items-center gap-2"
            >
            ...
            <a
              ...
              className="bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-md shadow-md transition duration-300 ease-in-out flex items-center gap-2"
            >
        ...
        <div className="lg:w-1/2 rounded-lg overflow-hidden shadow-lg">
          <img
            src="https://images.unsplash.com/photo-1556761175-b413da4baf72?q=80&w=3284&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Replace with your image URL
