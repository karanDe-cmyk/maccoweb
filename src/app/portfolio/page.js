...
function portfolio() {
  ...
  useEffect(() => {
    ...
    return (
        <>
            ...
            {/* <div className="bg-gradient-to-br from-gray-100 to-gray-50 py-16 md:py-24 bg-cover bg-center"
                style={{ backgroundImage: `url('https://wallpapers.com/images/featured/office-desk-pictures-a1yivbaxal92jim2.jpg')` }} // Added background image
            >
                <div className="container min-h-[30vh]  mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div
      ...
      style={{
        backgroundImage: `url('https://wallpapers.com/images/featured/office-desk-pictures-a1yivbaxal92jim2.jpg')`,
      }}
    >
